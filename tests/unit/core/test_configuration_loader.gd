...
func test_get_agents_returns_copy_not_mutable_reference() -> void:
	...
	# Typed-array assignment — bare literal silently fails the strict
	# Array[Dictionary] static type. Use append on an empty typed array.
	loader._agents.clear()
	loader._agents.append({"id": "a1", "display_name": "Agent 1", "endpoint_url": "http://x", "auth_token": "", "agent_type": "default", "room_slot": 0})
...
func test_set_setting_then_get_returns_value_and_emits_signal() -> void:
	# NOTE: GDScript 4.x lambdas can't reassign outer-scope vars; mutate in place.
	var loader: Node = _make_loader()
	loader._user_settings = {}
	var emitted_payload: Array = []
	loader.setting_changed.connect(func(key: String, value: Variant) -> void:
		emitted_payload.clear()
		emitted_payload.append(key)
		emitted_payload.append(value)
	)
...
func test_get_agent_by_unknown_id_returns_empty_dict() -> void:
	...
	loader._state = ConfigLoaderScript.STATE_READY
	loader._agents.clear()
	loader._agents.append({"id": "a1", "display_name": "A1", "endpoint_url": "http://x", "auth_token": "", "agent_type": "default", "room_slot": 0})
